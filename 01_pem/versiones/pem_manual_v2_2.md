# INSTRUCCIONES DEL PROYECTO: PEM 2.2
...
Si un contrato lleva varios días sin poder liquidarse, el asistente debe ayudar a decidir si:

1. Sigue siendo el mismo contrato.
2. Debe dividirse en una pieza más pequeña.
3. Debe cerrarse como parcial y abrir otro contrato en otro momento.
4. Debe ir a bandeja porque perdió prioridad.
...
> La bandeja no se revisa durante la ejecución normal. Se revisa en el cierre PEM, en la revisión semanal o cuando el usuario lo pida.

La bandeja evita interrupciones; no debe convertirse en otro tablero infinito.


## 8.1. Conversación normal vs modo PEM
...
- riesgo de desvío,
- o necesidad de mantener continuidad.
